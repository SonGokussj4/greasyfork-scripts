...
(function () {
  ...
  const SHOW_RATINGS_IN_DIARIES_KEY$1 = 'cc_show_ratings_in_diaries';
  ...
  class Csfd {
    ...
    getCandidateFilmLinks() {
      ...
      const showInDiaries = getFeatureState(SHOW_RATINGS_IN_DIARIES_KEY$1, true); // ZDE
      ...
      items: [
        {
          ...
          childrenItems: [
            ...
            },
            {
              ...
              storageKey: SHOW_RATINGS_IN_DIARIES_KEY$1,
              defaultValue: true,
  ...
  async function addSettingsButton() {
    ...
    settingsButton.querySelector('#cc-maint-reset-btn')?.addEventListener('click', () => {
      ...
      localStorage.removeItem(SHOW_RATINGS_IN_DIARIES_KEY$1);
